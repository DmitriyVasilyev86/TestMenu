# Generated by Django 2.0.2 on 2018-02-11 14:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.MenuCategories', verbose_name='Категория')),
                ('parent', models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='core.MenuItems', verbose_name='Родительский элемент')),
            ],
            options={
